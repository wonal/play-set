...
export const COUNT1 = "one";
export const COUNT2 = "three";
export const COUNT3 = "six";
export const FILL1 = "solid";
export const FILL2 = "hollow";
export const FILL3 = "striped";
export const COLOR1 = "orange";
export const COLOR2 = "green";
export const COLOR3 = "blue";
export const SHAPE1 = "circle";
export const SHAPE2 = "diamond";
export const SHAPE3 = "rectangle";
